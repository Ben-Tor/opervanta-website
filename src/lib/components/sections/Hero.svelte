...
<section class="relative overflow-hidden border-b border-white/10 py-16 sm:py-20">
	<div class="absolute inset-0 -z-10">
		<div class="absolute left-0 top-0 h-96 w-96 rounded-full bg-cyan-400/10 blur-3xl"></div>
	...
	<Container class="grid items-center gap-12 lg:grid-cols-[1fr_0.92fr]">
		<div>
			<p
				class="mb-5 inline-flex rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-slate-300 shadow-sm"
			>
				Software QA / Software improvement / Workflow automation
			</p>

			<h1 class="max-w-4xl text-4xl font-semibold tracking-tight text-white sm:text-5xl xl:text-6xl">
		...
		<div class="rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-2xl shadow-black/30 backdrop-blur">
			<div class="rounded-2xl border border-white/10 bg-slate-950/80 p-6">
				<p class="text-sm font-medium text-cyan-300">Operational focus</p>

				<h2 class="mt-3 text-2xl font-semibold tracking-tight text-white">
					Practical software review before bigger technical decisions.
				</h2>

				<p class="mt-4 text-sm leading-6 text-slate-300">
					We look for broken flows, unclear user steps, avoidable manual work, and process gaps
					that slow down teams or customers.
				</p>
